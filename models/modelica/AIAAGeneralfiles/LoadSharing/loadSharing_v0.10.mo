model loadSharing_v010
  ElectricalEnergyStorage.Batteries.Cells.Basic.StaticResistance singleCell(SOCini = 1, cellParameters = test1Parameters) annotation(
    Placement(visible = true, transformation(origin = {-260, 30}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Electrical.Analog.Sources.ConstantCurrent constantCurrent(I = 40) annotation(
  ...
  parameter ElectricalEnergyStorage.CellRecords.StaticResistance.Test1Parameters test1Parameters annotation(
